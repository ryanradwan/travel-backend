...
export const metadata: Metadata = { title: "Terms of Service — TravelBackend.com" };
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-sm max-w-none text-gray-700 space-y-6">
          <section>
            ...
            <p>By accessing or using TravelBackend.com (&ldquo;the Service&rdquo;), you agree to be bound by these Terms of Service. If you do not agree, do not use the Service. TravelBackend.com is operated by Vertix Travel LLC (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;).</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-navy">2. Description of Service</h2>
            <p>TravelBackend.com is an AI-powered business operations platform built for US travel businesses. The Service uses artificial intelligence to assist with itinerary creation, destination research, proposal writing, and other travel business tasks.</p>
          </section>
          ...
          <section>
            ...
            <p>TravelBackend.com uses AI to generate content including itineraries, proposals, destination research, and other outputs. You acknowledge that:</p>
            <ul className="list-disc ml-4 mt-2 space-y-1">
              ...
              <li>TravelBackend.com is not responsible for decisions made based on AI-generated content</li>
          ...
          <section>
            ...
            <p>Your use of the Service is also governed by our <Link href="/privacy" className="text-teal hover:underline">Privacy Policy</Link>. We do not sell your data to third parties. Client data you enter into TravelBackend.com remains yours.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-navy">7. Limitation of Liability</h2>
            <p>To the maximum extent permitted by law, Vertix Travel LLC shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of the Service. Our total liability shall not exceed the amount you paid in the 12 months preceding the claim.</p>
          </section>
          ...
          <section>
            ...
            <p>Questions about these Terms? Email us at <a href="mailto:legal@travelbackend.com" className="text-teal hover:underline">legal@travelbackend.com</a></p>
          </section>
        </div>
      </div>
    </div>
